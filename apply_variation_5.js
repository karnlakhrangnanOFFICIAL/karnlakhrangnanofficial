...
const newStyles = `
  <style>
    ...
    .goals-list li {
      display: flex; align-items: center; gap: 12px; padding: 8px 0; border-bottom: 1px solid var(--ink-faint);
    }
    ...
    .event-time { font-family: 'Space Mono', monospace; font-weight: 700; color: var(--gold); font-size: 1rem; }
    .event-icon-box { background: none; box-shadow: none; width: auto; height: auto; }
    .event-details { display: flex; align-items: center; gap: 12px; }
    .event-title { font-size: 0.75rem; color: var(--ink-muted); font-weight: normal; margin-left: auto; }
      ...
      container.innerHTML = \`
        ...
        <div class="details-grid">
          <aside class="sidebar-meta">
            ...
            <div>
              <span class="label" style="border-bottom: 1px solid var(--ink-faint); padding-bottom: 8px; margin-bottom: 12px; font-size: 0.9rem;">Goalscorers</span>
              \${goalsHtml}
            </div>
          </aside>
