...
let match = {
  ...
  events: [
...

    {
      type: "substitution",
      team: "home",
      player_in: "Sandy Baltimore",
      player_out: "Wieke Kaptein",
      minute: 82,
    },

    {
      type: "substitution",
      team: "away",
      player_in: "Anna Patten",
      player_out: "Lucia Kendall",
      minute: 77,
    },
    {
      type: "substitution",
      team: "away",
      player_in: "Georgia Mullett",
      player_out: "Amalie Vangsgaard",
      minute: 70,
    },
    {
      type: "substitution",
      team: "away",
      player_in: "Lily Murphy",
      player_out: "Mia McAulay",
      minute: 69,
    },
    {
      type: "substitution",
      team: "away",
      player_in: "Océane Deslandes",
      player_out: "Chasity Grant",
      minute: 69,
    },
    {
      type: "substitution",
      team: "away",
      player_in: "Miri Taylor",
      player_out: "Maya Hijikata",
      minute: 58,
    },
  ],
