...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const getTooltipText = (target) => {
    ...
    if (isTh) {
      text =
        target.getAttribute("data-tooltip-th") ||
    ...
    if (target) {
      ...
      if (
        ...
        (target.classList.contains("card-link") ||
          ...
          target.classList.contains("match-info-pill"))
      ) {
        if (
          !target.hasAttribute("title") &&
          !target.hasAttribute("data-tooltip-th") &&
          !target.hasAttribute("data-tooltip-en") &&
          !target.hasAttribute("data-original-title")
        ) {
          return;
        }
      }
  ...
  document.body.addEventListener("mouseout", (e) => {
    const target = e.target.closest(
      "[data-tooltip-th], [data-tooltip-en], [data-tooltip], [data-original-title], a, button, img, .tab-btn, .lang-toggle, .flag-icon"
    );
    if (target) {
...
function renderTeamNameHTML(teamName, options = {}) {
  ...
  if (isChelsea) {
    styleStr =
      "color: #D4AF37 !important; font-weight: 800 !important; text-shadow: 0 0 8px rgba(212, 175, 55, 0.8), 0 0 15px rgba(212, 175, 55, 0.4) !important;";
  } else if (isArsenal) {
    styleStr =
      "color: #ffffff !important; font-weight: normal !important; text-shadow: none !important;";
  }
...
function updateUIText() {
  ...
  document.querySelectorAll("[data-lang-th][data-lang-en]").forEach((el) => {
    const val =
      currentLang === "th" ? el.getAttribute("data-lang-th") : el.getAttribute("data-lang-en");
